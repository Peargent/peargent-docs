...
The Wikipedia Tool is a built-in Peargent **<u>[Tool](/docs/tools)</u>** that enables **<u>[Agents](/docs/agents)</u>** to search Wikipedia and extract knowledge from articles. It supports article search with fuzzy matching, summary extraction, related links, categories, multi-language support, and intelligent handling of disambiguation pages and missing articles.
...
if result["success"] and result["text"]:
    ...
    # Output will be max 300 characters with "..." if truncated
```
...
- **extract_links** (boolean, optional, default: True): Whether to extract internal Wikipedia links from the article
- **extract_categories** (boolean, optional, default: False): Whether to extract article categories
